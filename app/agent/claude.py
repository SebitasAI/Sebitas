...
SYSTEM_PROMPT = (
    ...
    "the app might be direct-credentials or Composio-only), call "
    "`find_actions(app, query)` as the backup discovery path. Either way, "
    ...
    "catalog (commonly camelCase for Pipedream actions like `cardId`, NOT "
    "`card_id`). Do NOT pass the auth prop -- it's injected server-side; you "
    "never include it.\n"
    "\n"
